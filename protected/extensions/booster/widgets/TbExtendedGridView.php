...
class TbExtendedGridView extends TbGridView
{
	...
	public function init()
	{
		...
		if ($this->bulkActions !== array() && isset($this->bulkActions['actionButtons'])) {
			if (!isset($this->bulkActions['class'])) {
				$this->bulkActions['class'] = 'ext.booster.widgets.TbBulkActions';
			}
	...
	public function renderChart()
	{
		...
		$buttons = Yii::createComponent(
			array(
				'class' => 'ext.booster.widgets.TbButtonGroup',
				'toggle' => 'radio',
				'buttons' => array(
					array(
		...
		$configChart = array(
			'class' => 'ext.booster.widgets.TbHighCharts',
			'id' => $chartId,
			'options' => $options,
...
class TbPercentOfTypeGooglePieOperation extends TbPercentOfTypeOperation
{
	...
	public function registerClientScript()
	{
		$chart = Yii::createComponent(
			array(
				'class' => 'ext.booster.widgets.TbGoogleVisualizationChart',
